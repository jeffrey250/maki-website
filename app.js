...
function exportChanges(){const payload={edits:edits(),videos:getVideos(),blocks:blockStore()};navigator.clipboard?.writeText(JSON.stringify(payload,null,2));alert('Changes copied to clipboard as JSON.')}
